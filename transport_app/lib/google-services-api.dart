...
class GoogleDistanceMatrixService {
  final String apiUrl =
      'http://192.168.1.6:5000/api/map/distance-matrix'; // Replace with your server URL
...
class GoogleReverseGeoCodeService {
  final String apiUrl =
      'http://192.168.1.6:5000/api/map/reverse-geocode'; // Replace with your server URL
...
class GoogleDirectionService {
  final String apiUrl =
      'http://192.168.1.6:5000/api/map/directions'; // Replace with your server URL
